...
const DashboardPage = () => {
  ...
  const { course, section, startTime, endTime, sessionId } =
    location.state || {};
  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      ...
      setStats([
        ...
        {
          label: "Face-recognition Confirmed Students",
          value: data.faceConfirmed,
        },
        {
          label: "Number of Verified Attendees",
          value: data.verifiedAttendees,
        },
      ]);
    ...
    datasets: [
      {
        ...
        backgroundColor: ["#4caf50", "#f44336"], // Green for attended, Red for absent
            ...
            {course && section && startTime && (
              ...
              >
                ...
                >
                  ...
                  {course.toUpperCase()} Session {section}
                </p>
                <p
                  style={{
                    margin: "4px 0 0 0",
